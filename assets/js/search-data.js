...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/engineeringbio.science/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/engineeringbio.science/research/";
          },
        },{id: "nav-team",
          title: "Team",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/engineeringbio.science/team/";
          },
        },{id: "nav-publications",
          title: "Publications",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/engineeringbio.science/news/";
          },
        },{id: "nav-resources",
          title: "Resources",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/engineeringbio.science/resources/";
          },
        },{id: "nav-contact",
          title: "Contact",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/engineeringbio.science/contact/";
          },
          ...
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2018-06-15-physorg-resistance-prediction/";
            },},{id: "news-pnas-39-in-this-issue-39-highlight",
          title: 'PNAS &amp;#39;In This Issue&amp;#39; highlight',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2018-06-19-pnas-in-this-issue/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2020-06-16-genengnews-recombineering/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-03-15-drug-discovery-news/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-03-15-hms-news/";
            },},{id: "news-interview-amp-ndash-nature-podcast",
          title: 'Interview &amp;amp;ndash; Nature Podcast',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-03-15-nature-podcast/";
            },},{id: "news-interview-genetic-engineering-amp-biotechnology-news",
          title: 'Interview @ Genetic Engineering &amp;amp; Biotechnology News',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-03-22-genengnews-interview/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-03-28-nature-news-views/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-04-05-science-feature/";
            },},{id: "news-highlight-in-synthetic-biology",
          title: 'Highlight in Synthetic Biology',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-04-08-synbio-journal-highlight/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-04-10-newscientist-recoded/";
            },},{id: "news-highlight-in-nature-biotechnology",
          title: 'Highlight in Nature Biotechnology',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-04-15-nature-biotech-highlight/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-04-21-thescientist-interview/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2023-12-20-hms-year-in-science/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2024-06-11-doe-highlight/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2024-07-16-dyss-uw/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2024-09-09-dot-session-chair/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2024-11-10-mrna-conference/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2024-11-10-nih-synbio-announce/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2024-11-26-nih-synbio-recording/";
            },},{id: "news-why-is-it-so-hard-to-rewrite-a-genome",
          title: 'Why is it so hard to rewrite a genome?',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2025-02-18-nature-rewrite-genome/";
            },},{id: "news-scientists-are-learning-to-rewrite-the-code-of-life",
          title: 'Scientists Are Learning to Rewrite the Code of Life',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2025-08-01-nyt-zimmer/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2025-09-14-dot-symposium-chair/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2025-09-28-rising-stars-award/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2025-10-15-aiche-faculty-candidates/";
            },},{id: "news-talk-aiche-annual-meeting-in-boston",
          title: 'Talk @ AIChE Annual Meeting in Boston',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2025-10-15-aiche-talk/";
          ...
          description: "",
          section: "News",handler: () => {
              window.location.href = "/engineeringbio.science/news/2026-03-23-newscientist-zombie-cells/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/engineeringbio.science/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/engineeringbio.science/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
